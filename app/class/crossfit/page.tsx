...
export default function CrossfitPage() {
  ...
  // Set para soportar múltiples FAQs abiertos simultáneamente
  ...
  function selectFirstTime(val: FirstTime) {
    setFirstTime(val);
    // "No" → ambas FAQs abiertas por defecto; "Sí" → todas cerradas
    if (val === "no") {
    ...
    <main className="bg-[#fbfbfb]">
      ...
      <div className="px-6 py-6">
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          {/* Card condicional — sólo aparece cuando hay selección */}
          {firstTime !== null && (
            <div className="flex flex-col gap-4 rounded-lg bg-[#262626] p-4">

              {/* Título */}
              <h2 className="font-heading text-[22px] font-bold uppercase tracking-wide text-nexo-orange">
