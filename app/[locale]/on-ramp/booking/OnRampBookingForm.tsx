...
function OnRampBookingContent({ fechasOnRamp }: { fechasOnRamp: { value: string; label: string }[] }) {
...
export default function OnRampBookingPage({ fechasOnRamp }: { fechasOnRamp: { value: string; label: string }[] }) {
  return (
    <Suspense>
      <OnRampBookingContent fechasOnRamp={fechasOnRamp} />
    </Suspense>
  );
}
