...
export default async function OnRampBookingConfirmPage() {
  const t = await getTranslations('onramp.confirm');
  const tc = await getTranslations('common');

  return (
    <main className="bg-[#fbfbfb]">
      <PageHero title={t('heroTitle')} titlePart2={t('heroTitlePart2')} imageSrc="/reserva-onramp.jpg" />
